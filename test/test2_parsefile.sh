...
#python  -u -X utf8 changesetmd.py -H localhost -P 5432 -u osm -p osm -d changesetmd_test --schema=testfile --trunc --geometry --bulkrows=500000 --bz2buffer=500000 --logfile --file=planet/changesets-latest.osm.bz2
